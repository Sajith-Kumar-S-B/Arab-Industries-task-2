    ...
    <div className="py-3">
      ...
      >
        ...
        <SwiperSlide>
          <animated.div style={textProps}>
            ...
            <div className="text" data-swiper-parallax="-100">
              <animated.p>
                Feel the wind rush past as you conquer the asphalt, pushing your
                car to its limits in a high-stakes race against time.
              </animated.p>
              <animated.img
                src={image1}
                width="225"
        ...
        <SwiperSlide>
          ...
          <div className="text" data-swiper-parallax="-100">
            <animated.p>
              Experience the thrill of precision steering and the roar of
              engines as you navigate challenging tracks, leaving your
        ...
        <SwiperSlide>
          ...
          <div className="text" data-swiper-parallax="-100">
            <animated.p>
              Racing isn't just about speed; it's about strategy, split-second
              decisions, and the exhilarating pursuit of victory.
            </animated.p>
            <animated.img
              src={image2}
              width="225"
        ...
        <SwiperSlide>
          ...
          <div className="text" data-swiper-parallax="-100">
            <animated.p>
              From screeching tires to heart-pounding drifts, each race is a
              symphony of adrenaline-fueled moments that define the joy of
              driving.
            </animated.p>
            <animated.img
              src={gif}
        ...
        <SwiperSlide>
          ...
          <div className="subtitle" data-swiper-parallax="-200">
            Enter the World of Drifts, Master Precision, and Blitz Your Way to
            Glory
          </div>
          <div className="text" data-swiper-parallax="-100">
            <animated.p>
              Behind the wheel, you're not just a driver; you're a master of the
              road, navigating twists and turns with skill and pushing your
